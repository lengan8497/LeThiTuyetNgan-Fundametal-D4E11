...
movies = data['results']   # results là kiểu dữ liệu list

# 1. In tên các bộ phim
# for movie in movies:
#     print(movie['title']) 


# 2. Input pop --> in ra phim có pop > input
# input_pop = int(input('Enter the pop of the movie: '))
# for movie in movies:
#     if movie['popularity'] > input_pop:
#         print(movie['title'])


# 3. In ra phim sản xuất năm 2019
# input_year = int(input('Enter the release year of the movie: '))
# for movie in movies:
...
# 4. Tính tổng số vote của các bộ phim
total = 0
for movie in movies:
